...
const DashboardLink = (props) => {
    ...
    return (
        <InertiaLink href="/dashboard" className="text-sm text-gray-700 underline">Dashboard</InertiaLink>
    )
}

const AuthenticationLinks = (canRegister) => {
    
    return (
        <>
            <InertiaLink href="/login" className="text-sm text-gray-700 underline">Log in</InertiaLink>
            {canRegister && <InertiaLink href="/register" className="ml-4 text-sm text-gray-700 underline">Register</InertiaLink>}
        </>
    )
}
    ...
    return (
        <div className="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            <div className="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                {canLogin
                    ? <AuthenticationLinks canRegister={canRegister} />
                    : <DashboardLink />
                }
            </div>
